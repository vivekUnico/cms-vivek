...
const { GetAllStudent, CreateStudent, GetSingleStudent, DeleteStudent, UpdateStudent,
        MoveEnquiryToStudent, StudentFees, StudentFeesAnalytics } = require("../../../controllers/student");
