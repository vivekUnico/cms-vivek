...
const tt = ["63b2933dd57c483013f232ae", "63aef76005f9c2538b7d621b", "63b297b5d57c483013f2439f", "636cddec43b9ddb13532337a", "63b00deb8041083fff3fa37f"];
...
confifDB().then(async () => {
	for (let i = 1; i <= 500; i += 1) {
		const result = await LeadAndEnquiry.create({
			...
			assign_to : ObjectId(tt[randomNUmber(0, 4)]),
		});
		await Followup.create({
			...
			followup_list : [{
				...
				addedTime : new Date(),
				completed : false,
				followup_by : ObjectId(tt[randomNUmber(0, 4)]),
			}]
		});
	}
});
